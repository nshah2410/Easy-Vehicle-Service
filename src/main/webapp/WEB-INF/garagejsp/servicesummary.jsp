                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li>
                                <i class="fa fa-users"></i><a href="vehiclerecieved.evs" style="text-decoration: none;"> Vehicle Recieved</a>
                            </li>
							<li>
                ...
                <div class="row">
		            ...
		            <div id="Summary" class="tabcontent padding-bottom-45">
		                ...
		                <div class="pedding-lr-15">
							...
							<div class="summary-row border-bottom">
		                            <button type="button" class="btn btn-primary btn-lg btn-block" onclick="addparts()"><span class="fa fa-plus-square"></span></button>
		                     </div>
		                ...
		                <div class="total-tax-wrp">
		                 ...
		                 <div class="summary-row border-bottom">
		                 	<button type="button" class="btn btn-success btn-lg btn-block" onclick="delivered(${request_id})"><span class="fa fa-check-square-o"> Approve & Delivered</span></button>
		                 </div>                
		            </div>
                </div>
                <!-- /.row -->
	...
	if(confirm("Are You Sure selected vehicle is delivered??")){
		$.ajax({
			...
			success: function() {
				...
				window.location.href="vehiclerecieved.evs";
			}
		});
}
}
