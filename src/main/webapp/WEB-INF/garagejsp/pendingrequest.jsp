                                ...
                                <tbody id="tbody">
                                	<c:forEach items="${request}" var="v" varStatus="count">
                                		<tr>
                                			...
                                			<td>
                                				<button type="button" onclick="accept(${v.rm.request_id})" class="btn btn-success">
                                  					<span class="glyphicon glyphicon-ok"></span>
                                				</button>
                                				/ 
                                  				<button type="button" onclick="decline(${v.rm.request_id})" class="btn btn-danger">
...
function decline(id){
	$.ajax({
		url: 'manipulate_request.evs',
		type: 'post',
		data: {action: "decline_request", id : id},
		success: function() {
